        ...
        <div className="space-y-10">
            ...
            <div className="flex justify-center items-center space-x-4">
                <button
                    ...
                    className={`px-4 py-2 rounded bg-main text-white ${currentPage === 1 ? "opacity-50 cursor-not-allowed" : "hover:bg-red-700"
                        }`}
                >
                    Anterior
                </button>
                ...
                <button
                    ...
                    className={`px-4 py-2 rounded bg-main text-white ${currentPage === postsData.totalPages ? "opacity-50 cursor-not-allowed" : "hover:bg-red-700"
                        }`}
                >
                    Próxima
                </button>
